...
import mobimage1 from '../images/bg_mob.png'
import mobimage2 from '../images/p1_mob.png'
import mobimage3 from '../images/p2i_mob.png'
import mobimage4 from '../images/p2ii_mob.png'
import mobimage5 from '../images/star_mob.png'
...
function Home() {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ...
      },
      {
        y: 0,
        scrollTrigger: {
          trigger: element.querySelector(".maincontent"),
          start: "top top",
          end: "bottom center",
          scrub: true
        }
  ...
  return (
    <div className=" overflow-x-hidden bg-white" ref={ref}>
      
      <section className='mainbody flex relative justify-center items-center h-screen text-center'>
        <img className='absolute bottom-0 left-0 w-full h-full pointer-events-none' src={image1} id="bgp" alt=''/>
      ...
      <section className='maincontent relative hidden justify-center items-center h-screen text-center'>
